...
maps.n["Q"] = "<Nop>"
maps.n["sv"] = { "<cmd>vsplit<cr>", desc = "Vertical Split" }
maps.n["ss"] = { "<cmd>split<cr>", desc = "Horizontal Split" }
...
if is_available "smart-splits.nvim" then
  ...
  maps.n["sl"] = { function() require("smart-splits").move_cursor_left() end, desc = "Move to left split" }
  ...
  maps.n["sh"] = { function() require("smart-splits").move_cursor_right() end, desc = "Move to right split" }
...
maps.n["<C-a>"] = { "gg<S-v>G", desc = "Vertical Split" }
